                  ...
                  <div class="col-lg-3 col-md-2 col-12 crancy-personals__list">
                    <div class="crancy-psidebar">
                      ...
                      <div class="list-group crancy-psidebar__list" id="list-tab" role="tablist">
                        <a class="list-group-item active" data-bs-toggle="list" href="#id1" role="tab"><span class="crancy-psidebar__icon"><svg width="17" height="21" viewBox="0 0 17 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="list-group-item" data-bs-toggle="list" href="#id5" role="tab">
                            <span class="crancy-psidebar__icon crancy-psidebar__icon--fill"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <a class="list-group-item" data-bs-toggle="list" href="#id6" role="tab"><span class="crancy-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <a class="list-group-item" data-bs-toggle="list" href="#id7" role="tab"><span class="crancy-psidebar__icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      ...
                      <div class="crancy-ptabs__inner">
                        <div class="tab-content" id="nav-tabContent">
                          ...
                          <div class="tab-pane fade show active" id="id1" role="tabpanel">
                            <!--Personal Info--> 
                            <?= $this->include('patient/profile/profile') ?>
                          </div>
                          <div class="tab-pane fade" id="id5" role="tabpanel">
                            <!--Faq-->
                            <?= $this->include('patient/profile/faq') ?>
                          </div>
                          <div class="tab-pane fade" id="id6" role="tabpanel">
                            <!--Password Reset-->
                            <?= $this->include('patient/profile/password') ?>
                          </div>
                          <div class="tab-pane fade" id="id7" role="tabpanel">
                            <!--Terms of use-->
                            <?= $this->include('patient/profile/terms_of_use') ?>
                          </div>
                        </div>
                      </div>
                    </div>
