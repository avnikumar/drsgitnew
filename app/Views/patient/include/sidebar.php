        ...
        <div class="admin-menu__one crancy-sidebar-padding mg-top-20">
            ...
            <div class="menu-bar">
                <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
                    <li class="active">
                        <a class="collapsed" href="<?= base_url('patient/dashboard') ?>">
                    ...
                    <li>
                        <a class="collapsed" href="<?= base_url('patient/my_bookings') ?>"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                    ...
                    <li>
                        <a class="collapsed" href="<?= base_url('patient/my_doctors') ?>"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                        ...
                        <span class="menu-bar__name">My Doctors</span></span></a>
                    </li>
                    <li>
        ...
        <div class="crancy-sidebar-padding pd-btm-40">
            ...
            <div class="menu-bar">
                <ul class="menu-bar__one crancy-dashboard-menu" id="CrancyMenu">
                    <li>
                        <a href="<?= base_url('patient/my_settings') ?>" class="collapsed"><span class="menu-bar__text">
                            <span class="crancy-menu-icon crancy-svg-icon__v1">
