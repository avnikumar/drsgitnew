                            ...
                            <div class="crancy-header__nav-bottom">
                                ...
                                <div class="logo crancy-sidebar-padding">
                                    <a class="crancy-logo" href="index.html">
                                        <!-- Logo for Default -->
                                        <img class="crancy-logo__main" src="/public/inner/img/logo.png" alt="#" />
                                        <img class="crancy-logo__main--dark" src="/public/inner/img/logo-dark.png" alt="#" />
                                        <!-- Logo for Dark Version -->
                                        <img class="crancy-logo__main--small" src="/public/inner/img/logo-icon.png" alt="#" />
                                    ...
                                    <div class="crancy-header__right">
                                        ...
                                        <div class="crancy-header__single">
                                            ...
                                            <a class="crancy-language_main">
                                                <img src="/public/inner/img/flag-selected.png" />
                                            </a>
                                            <!-- Dropdown List -->
                                            <div class="crancy-dropdown crancy-language">
                                                <div class="crancy-dropdown__heading">
                                                    ...
                                                    <a href="#" class="crancy-dropdown__toggle"><img src="/public/inner/img/toggle-icons.svg" /></a>
                                                </div>
                                                <div class="crancy-dropdown__hover--inner">
                                                    <ul class="crancy-dlanguage">
                                                        <a class="active" href="#">
                                                            <span class="crancy-dlanguage__icon"><img src="/public/inner/img/language-check-icon.svg" /></span>
                                                            <img class="crancy-dlanguage__img" src="/public/inner/img/flag-1.png" />
                                                        ...
                                                        <a href="#">
                                                            <span class="crancy-dlanguage__icon"><img src="/public/inner/img/language-check-icon.svg" /></span>
                                                            <img class="crancy-dlanguage__img" src="/public/inner/img/flag-2.png" />
                                                            <h4 class="crancy-dlanguage__title">
                                                                German
                                                            </h4>
                                                        </a>
                                                        <a href="#">
                                                            <span class="crancy-dlanguage__icon"><img src="/public/inner/img/language-check-icon.svg" /></span>
                                                            <img class="crancy-dlanguage__img" src="/public/inner/img/flag-3.png" />
                                                            <h4 class="crancy-dlanguage__title">
                                                                French
                                                            </h4>
                                                        </a>
                                                        <a href="#">
                                                            <span class="crancy-dlanguage__icon"><img src="/public/inner/img/language-check-icon.svg" /></span>
                                                            <img class="crancy-dlanguage__img" src="/public/inner/img/flag-4.png" />
                                                            <h4 class="crancy-dlanguage__title">
                                                                Chinese
                                                            </h4>
                                                        </a>
                                                        <a href="#">
                                                            <span class="crancy-dlanguage__icon"><img src="/public/inner/img/language-check-icon.svg" /></span>
                                                            <img class="crancy-dlanguage__img" src="/public/inner/img/flag-5.png" />
                                                            <h4 class="crancy-dlanguage__title">
                                                                Swedish
                                                            </h4>
                                                        </a>
                                                        <a href="#">
                                                            <span class="crancy-dlanguage__icon"><img src="/public/inner/img/language-check-icon.svg" /></span>
                                                            <img class="crancy-dlanguage__img" src="/public/inner/img/flag-6.png" />
                                                            <h4 class="crancy-dlanguage__title">
                                                                Spanish
                                                            </h4>
                                                        </a>
                                                ...
                                                <div class="crancy-dropdown crancy-dropdown__messages">
                                                    ...
                                                    <ul class="crancy-balance_list crancy-header-messages">
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/chat-author1.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title">
                                                                        ...
                                                                        <a class="crancy-header-messages__btn">Send</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/chat-author2.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title">
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/chat-author3.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title">
                                                                                <a href="inbox.html">Devon Lane</a>
                                                                        ...
                                                                        <a class="crancy-header-messages__btn crancy-header-messages__btn--warning">Warning</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/chat-author4.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title">
                                                                                <a href="inbox.html">Brooklyn Simmons</a>
                                                                            </h4>
                                                                            <p class="crancy-header-messages__desc">
                                                                                Alcohol based ...
                                                                            </p>
                                                    ...
                                                    <div class="crancy-dropdown__button">
                                                        <a href="#" class="crancy-dropdown__view">View All <i class="fa fa-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                                <!-- End Dropdown List -->
                                            </div>
                                                ...
                                                <div class="crancy-dropdown crancy-dropdown__messages">
                                                    ...
                                                    <ul class="crancy-balance_list crancy-header-messages">
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/notify-1.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title crancy-header-messages__title--v2">
                                                                                <a href="inbox.html">Withdraw USDT</a>
                                                                            </h4>
                                                                            <p class="crancy-header-messages__desc">
                                                                                $659.10
                                                                            </p>
                                                                        </div>
                                                                        <a class="crancy-header-messages__btn crancy-header-messages__btn--completed">Completed</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/notify-2.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title crancy-header-messages__title--v2">
                                                                                <a href="inbox.html">Withdraw USDT</a>
                                                        ...
                                                        <li>
                                                            <div class="crancy-header-messages__inner">
                                                                <div class="crancy-header-messages__author">
                                                                    <img src="/public/inner/img/notify-3.png" alt="#" />
                                                                    <div class="crancy-header-messages__contnt">
                                                                        <div class="crancy-header-messages__inside">
                                                                            <h4 class="crancy-header-messages__title crancy-header-messages__title--v2">
                                                                                <a href="inbox.html">New Login Activity</a>
                                                                            </h4>
                                                                            <p class="crancy-header-messages__desc">
                                                                                Ip : 192.168.1.1
                                                                            </p>
