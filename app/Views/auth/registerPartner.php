...
<div class="container-reg">
  ...
  <div class="form-container-reg">
    ...
    <?php endif; ?>
      <form id="registerForm" action="<?= base_url('register-partner') ?>" method="POST">
        <div class="row">
          <?= csrf_field() ?>
          <!-- CSRF Token -->
          ...
          <div class="input-group col-lg-6 mb-4">
            ...
            <input id="companyName" type="text" name="company_name" value="<?= set_value('company_name') ?>" placeholder="Company Name" class="form-control bg-white border-left-0 border-md">
            <?php
            if (isset($validation)) :
              if ($validation->hasError('company_name')) : ?>
                <span class="errMsg"><?= $validation->getError('company_name') ?></span>
            <?php endif;
            endif; ?>
          </div>
          ...
          <div class="input-group col-lg-6 mb-4">
            ...
            <input id="companyContactFullName" type="text" name="company_contact_name" value="<?= set_value('company_contact_name') ?>" placeholder="Company Contact Full Name" class="form-control bg-white border-left-0 border-md">
            <?php
            if (isset($validation)) :
              if ($validation->hasError('company_contact_name')) : ?>
                <span class="errMsg"><?= $validation->getError('company_contact_name') ?></span>
            <?php endif;
            endif; ?>
          </div>
         ...
         <!-- Company Contact Email -->
          <div class="input-group col-lg-6 mb-4">
            ...
            <input id="companyContactEmail" type="email" name="email" value="<?= set_value('email') ?>" placeholder="Company Contact Email" class="form-control bg-white border-left-0 border-md">
          ...
          <div class="input-group col-lg-6 mb-4">
            ...
            <input id="panNumber" type="text" name="pan_number" maxlength="10" placeholder="PAN Number" value="<?= set_value('pan_number') ?>" class="form-control bg-white border-left-0 border-md" oninput="this.value = this.value.toUpperCase()">
            <?php if (isset($validation)) :
              if ($validation->hasError('pan_number')) : ?>
                <span class="errMsg"><?= $validation->getError('pan_number') ?></span>
            <?php endif;
            endif; ?>
          </div>
          <!-- GST Number -->
          <div class="input-group col-lg-6 mb-4">
            ...
            <input id="gstNumber" type="text" name="gst_number" maxlength="15" placeholder="GST Number" value="<?= set_value('gst_number') ?>" class="form-control bg-white border-left-0 border-md">
            <?php if (isset($validation)) :
              if ($validation->hasError('gst_number')) : ?>
                <span class="errMsg"><?= $validation->getError('gst_number') ?></span>
            <?php endif;
            endif; ?>
          </div>
          ...
          <div class="text-center w-100">
            <p class="text-muted font-weight-bold">Already Registered? <a href="<?= base_url('login-partner') ?>" class="login-text ml-2">Login</a></p>
          </div>
        </div>
      </form>
