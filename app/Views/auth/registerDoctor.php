...
<div class="container-reg">
  ...
  <div class="form-container-reg">
    ...
    <form id="registerForm" action="<?= base_url('register-doctor') ?>" method="POST">
      <div class="row">
        <?= csrf_field() ?>
        <!-- CSRF Token -->
        ...
        <div class="input-group col-lg-6 mb-4">
          ...
          <input id="licenseNumber" type="text" name="license_number" value="<?= set_value('license_number') ?>" placeholder="License Number" class="form-control bg-white border-left-0 border-md">
          <?php if (isset($validation)) :
        ...
        <div class="text-center w-100">
          <p class="text-muted font-weight-bold">Already Registered? <a href="<?= base_url('login-doctor') ?>" class="login-text ml-2">Login</a></p>
        </div>
      </div>
    </form>
